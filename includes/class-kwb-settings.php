...
final class KWB_Settings {
	...
	<tr><th><?php echo esc_html(KWB_I18n::t('event_title'));?></th><td><input class="regular-text" name="<?php echo esc_attr(self::OPTION.'[calendar_title_template]');?>" value="<?php echo esc_attr($s['calendar_title_template']);?>"><p class="description"><?php echo esc_html(KWB_I18n::t('placeholders'));?>: {{workshop}}, {{date}}, {{time}}, {{order_number}}</p></td></tr>
