...
$sanitized=KWB_Settings::sanitize(array(
    'reminder_enabled'=>1,
    ...
    'rsvp_cutoff_minutes'=>15,
    'calendar_alarm_minutes'=>120,
    'default_horizon_months'=>4,
    'default_capacity'=>12,
    'reminder_subject_template'=>'Reminder {{workshop}}',
    'reminder_message_template'=>'See you {{date}} {{time}}',
));
kwb_assert(180===$sanitized['reminder_lead_minutes'],'configurable reminder lead time failed');
